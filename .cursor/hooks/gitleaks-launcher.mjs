...
const CONFIG = {
  toolName: "gitleaks-launcher",
  packageNameEnv: "GITLEAKS_HOOK_PACKAGE_NAME",
  projectIdEnv: "GITLEAKS_HOOK_PROJECT_ID",
  versionEnv: "GITLEAKS_HOOK_VERSION",
  gitlabUrlEnv: "HOOKS_GITLAB_URL",
  requestTimeoutEnv: "HOOKS_REGISTRY_TIMEOUT_MS",
  defaultGitlabUrl: "https://gitlab.biocad.ru",
  defaultPackageName: "gitleaks-hook",
  defaultProjectId: "3168",
  defaultRequestTimeoutMs: 5000,
  vendorDirName: "gitleaks",
  binaries: {
    "darwin-arm64": "gitleaks-hook-darwin-arm64",
    "darwin-x64": "gitleaks-hook-darwin-amd64",
    "linux-x64": "gitleaks-hook-linux-amd64",
    "linux-arm64": "gitleaks-hook-linux-arm64",
    "win32-x64": "gitleaks-hook-windows-amd64.exe"
  }
};
...
function getProjectId() {
  ...
  return value && value.trim() ? value.trim() : CONFIG.defaultProjectId;
}
